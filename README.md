...
Рабочий MVP русскоязычного сервиса аналитики рынка IT-профессий. Текущий публичный release — [`0.1.0`](CHANGELOG.md). Он показывает спрос, зарплаты, Junior/Middle/Senior, выборку, confidence, тренды, типичный стек и объяснимый индекс 0–100. Главный зарплатный график и карточки используют всю сопоставимую зарплатную выборку собственных совпадений профессии из официального HH API: валюты приводятся к RUB, net — к gross, односторонняя граница — к оценке центра, затем зарплаты делятся на три непрерывных сегмента в пропорциях собственных требований роли к опыту. Бесплатный API и SSR получают не более 30 дней истории; Premium может запросить до 180 накопленных календарных дней. «Работа России», подготовленная 180-дневная витрина и открытые исследования остаются отдельными слоями.
...
Основной публичный зарплатный слой использует все сопоставимые HH-записи собственной профессии. RUB/USD/EUR/KZT приводятся в RUB по сохранённому курсу ЦБ, net пересчитывается в gross по шкале НДФЛ, полная вилка представляется midpoint, а одна граница — центром, оценённым через типичную ширину полных вилок роли. В каждом 30-дневном окне зарплаты сортируются и делятся на Junior/Middle/Senior в пропорциях требований роли к опыту со слабым prior 15/45/40; сумма `n` сегментов равна полной использованной выборке. Направление и общий IT-рынок в профессию не подставляются. Бесплатная выдача физически обрезает историю до 30 дней, Premium — до 180 накопленных дней; 90/180 не являются прогнозом. «Работа России» продолжает публиковать свои точные счётчики и provenance отдельно.
