...
Команда не перезаписывает AI- или ручные решения. Текущий `rules-v3` объединяет слишком узкие технологические дубли с их устойчивыми профессиями и добавляет массовые роли с консервативными исключениями. На локальном HH-снимке от 2026-08-05 классифицировано 11 132 из 42 153 уникальных вакансий; у всех 50 профессий есть не менее пяти собственных совпадений. Актуальные production-счётчики фиксируются в `HANDOFF.md` после каждого полного прохода.
