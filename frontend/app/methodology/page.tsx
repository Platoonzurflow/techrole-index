...
const faq = [
  ...
  ["Почему вместо зарплаты бывает «Недостаточно данных»?", "TechRole Index не публикует итоговую midpoint-статистику, если наблюдений меньше настроенного порога. По умолчанию требуется не менее 20 записей с двумя границами вилки."],
...
export default function MethodologyPage() {
  ...
  return (
    <article className="shell py-12">
      ...
      <h1 className="mt-3 text-4xl font-bold">Методология без чёрного ящика</h1>
      <p className="mt-5 max-w-3xl text-lg leading-8 text-muted">TechRole Index - сравнительный индикатор 0-100, а не обещание зарплаты и не карьерный прогноз. Показатели доступны вместе с датой, выборкой и confidence.</p>
      <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_.8fr]">
        <section className="panel p-6">
          ...
          <div className="mt-5 grid gap-4 leading-7 text-muted">
            ...
            <p>При менее чем 20 midpoint-наблюдениях медиана и среднее скрыты как «Недостаточно данных». Порог конфигурируется через <code>MIN_SALARY_SAMPLE</code>.</p>
          </div>
        </section>
        <section className="panel p-6">
