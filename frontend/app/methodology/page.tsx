      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_.8fr]">
        <section className="panel p-6">
          ...
          <div className="mt-5 grid gap-4 leading-7 text-muted">
            ...
            <p>Медиана вакансий публикуется минимум по трём полным вилкам: n=3 уже считается достаточным проверяемым срезом. При меньшем числе наблюдений интерфейс показывает отдельно подписанный ориентир из открытого исследования. Порог задаётся через <code>MIN_SALARY_SAMPLE</code>.</p>
          </div>
        </section>
        <section className="panel p-6">
