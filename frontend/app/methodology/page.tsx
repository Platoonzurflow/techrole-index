...
const faq = [
  ...
  ["Как отсекаются слишком низкие вилки в графике?", "Только для динамического графика midpoint вакансии должен быть не ниже 40% видимой базовой медианы для Junior, 70% для Middle и 100% для Senior. Сначала строится ряд точной профессии, затем направления; исходные публикации и показатели полноты не удаляются."],
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_.8fr]">
        <section className="panel p-6">
          ...
          <div className="mt-5 grid gap-4 leading-7 text-muted">
            ...
            <p>Динамический график применяет воспроизводимую нижнюю границу к midpoint полной вилки: 40% видимой базовой медианы для Junior, 70% для Middle и 100% для Senior. Базовая медиана выбирается в порядке точная профессия → технология → смежная роль → направление. После фильтра сначала проверяется точная профессия, затем направление; если обоих рядов недостаточно, остаётся пунктирный ориентир общего рынка. Это правило не меняет зарплатные ориентиры, исходные публикации, их число или график полноты.</p>
          </div>
        </section>
        <section className="panel p-6">
