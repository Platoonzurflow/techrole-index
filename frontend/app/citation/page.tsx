...
export default async function CitationPage() {
  ...
  const schema = {
    ...
    description: "Публичные описания 50 IT-профессий, source-isolated агрегаты «Работы России» и одобренного HH API, а также отдельные зарплатные срезы.",
    ...
    isBasedOn: ["https://trudvsem.ru/opendata", "https://api.hh.ru/openapi/redoc"],
    subjectOf: {
      "@type": "CreativeWork",
    ...
    distribution: [
      ...
      { "@type": "DataDownload", contentUrl: `${siteUrl}/hh-market-daily.json`, encodingFormat: "application/json" },
      { "@type": "DataDownload", contentUrl: `${siteUrl}/hh-market-daily.csv`, encodingFormat: "text/csv" },
